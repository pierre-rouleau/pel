...
;; Time-stamp: <2026-04-30 14:42:19 EDT, updated by Pierre Rouleau>
...
Exclude pel-pkg, pel-autoloads, pel_keys, pel__hydra and some other files that
must not be taken into account by the statistics."
  (let* ((current-dir-files (process-lines "git" "ls-files" "--" ":(glob)*.el"))
         (excluded '(".dir-locals.el"
                     "install-pel.el"
                     "pel-autoloads.el"
                     "pel-pkg.el"
                     "pel_keys.el"
