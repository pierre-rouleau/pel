...
;; Time-stamp: <2026-04-30 14:10:04 EDT, updated by Pierre Rouleau>
...
Use this to compute statistics."
  (interactive)
  ;; [:todo 2026-04-30, by Pierre Rouleau: Change this hard-coded list to a
  ;; list inferred from the content of the directory and check if each file is
  ;; committed in the Git repo. Exclude autoloads.el, pel-pkg.el pel__hydra.el]
