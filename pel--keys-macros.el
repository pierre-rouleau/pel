...
;; Time-stamp: <2026-05-07 13:57:16 EDT, updated by Pierre Rouleau>
...
(defconst pel---prefix-to-topic-alist-1
  ...
  `(
    ...
    ([f11 32 ?F]     "pl-fortran"       pel-pkg-for-fortran     fortran) ; FORTRAN-77
    (,(kbd "<f11> SPC M-F") "pl-fortran" pel-pkg-for-fortran    fortran) ; FORTRAN-90
    ...
    ([f11 6]         "faces-fonts"     pel-pkg-for-face-font    face-explorer)
