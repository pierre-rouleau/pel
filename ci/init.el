...
;;  Update history:
;;
;;  - File created: Thursday, March 29, 2018. by Pierre Rouleau
;;
;;  RCS $Revision: $
;;
;; ---------------------------------------------------------------------------
...
(defconst pel-init-support-dual-environment-p t
...
;; - On GitHub CI/CD the directory is controlled by Github.
(defconst pel-home-dirpath-name (expand-file-name (getenv "GITHUB_WORKSPACE"))
...
(let ((file-name-handler-alist nil))
 ...
 from user-emacs-directory")))
  ...
  ;; (eval '(setq inhibit-startup-echo-area-message "me"))
  ...
  ;; Adding more keys in terminal mode
  ;; ---------------------------------
  ...
  ;; This code is disabled in Github CI/CD
  ...
  ;;
  ;; -- There's no util in Github CI/CD environment
