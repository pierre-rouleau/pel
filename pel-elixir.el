...
;;-pel-autoload
(defun pel-elixir-insert-indent-info ()
...
- Under PEL, Elixir indentation level width is controlled entirely by the
  ...
  `tab-width' to the same value of `pel-elixir-indent-width' and then
...
(defun pel-elixir-insert-tab-info ()
  "Insert Elixir indentation and hard tab setup info in current context.
Return a list of generic symbols described."
  (insert "
...
(defun pel--elixir-minor-mode-info ()
  "Insert information related to Elixir minor modes."
  (insert "
Automatic activation of minor mode is also controlled by the
following user-options:")
  (pel-insert-list-content 'pel-elixir-activates-minor-modes
                           nil nil nil :1line))
