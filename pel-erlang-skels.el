...
;; TODO: gen_fsm is being replaced by gen_statem in newer Erlang versions.
;;       Add support for gen_statem and provide the behaviours that are
;;       available to the version of Erlang being run.
