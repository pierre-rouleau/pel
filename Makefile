...
# Last Modified Time-stamp: <2026-09-02 16:27:28 EDT, updated by Pierre Rouleau>
...
help:
	...
	@printf "    - pel.el\n"
	@printf "    - pel-pkg.el\n"
	@printf "  Note: building a PEL package is not needed to use PEL.\n"
	@printf "        This is for experimental use only.\n"
	@printf "\n"
...
bin/pel-lint-declarations.elc:  pel-elcode.elc
...
pel-elcode.elc:           pel--base.elc pel-elisp.elc
...
pel-org.elc:              pel--base.elc pel--keys-macros.elc
...
test/pel-elisp-eval-test.el.test-passed:        pel-elisp-eval.elc pel-ert.elc
...
test/pel-rst-test.el.test-passed:               pel-rst.elc pel--base.elc doc/pel-manual.rst
...
ifeq ($(EMACS_NATIVE_COMP_AVAILABLE), yes)
bin/pel-lint-declarations.elc: bin/pel-lint-declarations.el pel-elcode.elc
...
ifeq ($(PEL_FAST_STARTUP),yes)
	...
	@printf "NOTE:    This almost represents what PEL uses in terms of packages in fast startup.\n"
	...
	@$(EMACS) --batch -L . \
	  -l "$(EMACS_INIT)" -l pel-package.el -f pel-package-info-all
	@printf "NOTE:    The Emacs init-time shown here is the Emacs batch mode\n"
...
.PHONY: lint validate-key-prefixes validate-declarations
