...
;;; Commentary:
;;
;; This file provides the following extensions to ibuffer:
;;
;; - Sorting ibuffer by directory.
...
;; Credit: jpkotta
;;
;; The code in this section of the file is heavily based on code posted by
;; jpkotta, October 29, 2015 from:
  ...
  (:description "directory name"
                ...
                (intern
                 (completing-read "Filter by directory: "
                                  (pel--get-all-buffer-directories)
                                  'identity
                                  t nil nil nil nil)))
  (string= qualifier
