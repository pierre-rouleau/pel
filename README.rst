...
.. image:: https://img.shields.io/badge/PDF_Files-193-blue
   :alt: Version
...
- document Emacs features in several (193) topic oriented PDF tables which
...
- PEL provides **193** `PDF topic-oriented reference sheets`_ [#doc]_ packed
