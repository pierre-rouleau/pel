...
.. image:: https://img.shields.io/badge/PEL_Managed_Packages-338-teal
   :alt: Version
...
- provides the ability to easily install, update a large set (338) of external
...
- In normal mode, PEL controls the download, installation, configuration and
  activation of **338** *top-level* [#externp]_ external packages through the
...
.. [#externp] An external package may have dependencies.  The dependencies are also
              installed. PEL currently provides access to 338 top-level external packages.
