...
.. image:: https://img.shields.io/badge/PDF_Files-225-blue
   :alt: PDF Files
...
- **225 Extensive Topic-organized Reference Quick Sheet PDFs**  (see `PEL PDF
  Tables`_ below).
...
PEL provides **225** `topic oriented PDF quick-reference tables`_ [#doc]_,
